...
using namespace std;
//ѕерев≥рка чи попав гравець чи н≥
...
//ѕереп≥рка чи горизонтальй або вертикальний корабель або одиничка
...
//ѕерев≥рка чи потоплений корабель
bool IsSunkenShip(char BoardPlayer[SIZEBOARD][SIZEBOARD], char BoardShip[SIZEBOARD][SIZEBOARD],short int RowPlayer,short int ColPlayer) {
	...
	//ѕерев≥рка чи потоплений горизонтальний корабель
	...
	//ѕерев≥рка чи потоплений вертикальний корабель
	...
	//≤накше одиничка потоплена
	else
		return true;
}

//‘арбуванн€ пошкодженого корабл€ в потоплений та фарбуванн€ наколо нього знаку '!'
void FarbSunkenShip(char BoardPlayer[SIZEBOARD][SIZEBOARD], char BoardShip[SIZEBOARD][SIZEBOARD],short int RowPlayer,short int ColPlayer) {
	...
	//‘арбуванн€ горизонтального корабл€
	if (VerticalOrGorisontalShip(BoardShip, RowPlayer, ColPlayer) == 2) {
